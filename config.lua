...
Config.Locations = {
    ["checking"] = vector3(312.49, -593.0, 43.28),
    ["duty"] = {
        [1] = vector3(310.53, -597.1, 43.28),
...
Config.AuthorizedVehicles = {
	...
	[0] = {
        ["NHSoctavia"] = "Octavia",
        ["NHSdisco"] = "Discovery",
        ["NHSmercresponse"] = "HART Sprinter 2020",
        ["ambulance"] = "Ambulance Sprinter 2015",
        ["LAS3"] = "VW Tiguan",
        ["NHSducato"] = "Ambulance Fiat",
        ["NHSrenault"] = "Ambulance Renault",
        ["nhsrange"] = "Range Rover - Rapid Response",
	},
	-- Grade 1
	[1] = {
        ["NHSoctavia"] = "Octavia",
